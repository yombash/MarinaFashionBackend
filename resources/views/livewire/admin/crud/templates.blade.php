<div>
    ...
    <table class="table mt-4">
        ...
        @forelse ($products as $product)
            <tr>
                <td><a href="{{url('admin/tables/fashions/'.$product->id)}}"> {{ $product->name }}</a></td>
                <td nowrap="">
            ...
            <div class="modal-content">
                <form wire:submit.prevent="save">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $productId ? 'Редактирование' : 'Добавление нового шаблона (модели)'
                        }}</h5>
                    ...
                    <div class="modal-body">
                        <h6>В привязке к группе шаблонов: {{$parentName}}</h6>
                        Наименование:
                        <br/>
